...
export default function QuestionCard({
  ...
  return (
    ...
    >
      ...
      {/* Answer field previews */}
      {question.type === 'short' && (
        <input disabled className="fb-answer-preview" placeholder="Short answer text" />
      )}
      {question.type === 'paragraph' && (
        <textarea disabled className="fb-answer-preview fb-answer-textarea" placeholder="Long answer text" rows={3} />
      )}
      {question.type === 'date' && (
        <input disabled type="date" className="fb-answer-preview" />
      )}
      {question.type === 'time' && (
        <input disabled type="time" className="fb-answer-preview" />
      )}
